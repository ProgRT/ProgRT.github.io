...
\begin{frame}{Pour revoir ce contenu}
    \centering
    \color{bleufonceqhum}\qrcode[hyperlink, height=4cm]{https://respiratoire.ca/billets/PAV+/article.html}
    \\[\baselineskip]
    \url{https://respiratoire.ca/billets/PAV+/article.html}
\end{frame}
